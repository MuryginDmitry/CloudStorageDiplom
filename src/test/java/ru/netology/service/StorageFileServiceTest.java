...
class StorageFileServiceTest {
    ...
    @Test
    void editFileName() {
        storageFileService.editFileName(BEARER_TOKEN, FILENAME_1, FILE_NAME_EDIT_REQUEST);
    ...
    void editFileNameUnauthorized() {
        assertThrows(UnauthorizedException.class, () -> storageFileService.editFileName(TOKEN_1, FILENAME_1, FILE_NAME_EDIT_REQUEST));
    }
